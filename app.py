...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres.zsscaqtbfasrseodhwbt:Moh317632m%40%40db@aws-0-me-central-1.pooler.supabase.com:6543/postgres?sslmode=require'
